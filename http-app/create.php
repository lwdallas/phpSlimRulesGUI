...
// curl -X POST -d "ruleset=1" -d "rule_active=0" -d "rule_comment=ignore this one" -d "rule=something = 1 and another < 10 or unfinished idea" http://127.0.0.1:3000/rule/3
...
curl_setopt($ch, CURLOPT_URL,"http://127.0.0.1:3000/rule");
...
<?php
		...
		echo "$server_output - error creating rule";
		}
		?></td><?php
if ($server_output != false){
?>
